...
::grpc::Status KVStoreService::Stub::Remove(::grpc::ClientContext* context, const ::kvstore::RemoveRequest& request, ::kvstore::RemoveResponse* response) {
...
void KVStoreService::Stub::async::Remove(::grpc::ClientContext* context, const ::kvstore::RemoveRequest* request, ::kvstore::RemoveResponse* response, std::function<void(::grpc::Status)> f) {
...
void KVStoreService::Stub::async::Remove(::grpc::ClientContext* context, const ::kvstore::RemoveRequest* request, ::kvstore::RemoveResponse* response, ::grpc::ClientUnaryReactor* reactor) {
...
::grpc::ClientAsyncResponseReader< ::kvstore::RemoveResponse>* KVStoreService::Stub::PrepareAsyncRemoveRaw(::grpc::ClientContext* context, const ::kvstore::RemoveRequest& request, ::grpc::CompletionQueue* cq) {
...
::grpc::ClientAsyncResponseReader< ::kvstore::RemoveResponse>* KVStoreService::Stub::AsyncRemoveRaw(::grpc::ClientContext* context, const ::kvstore::RemoveRequest& request, ::grpc::CompletionQueue* cq) {
  auto* result =
...
KVStoreService::Service::Service() {
  ...
  AddMethod(new ::grpc::internal::RpcServiceMethod(
      ...
      ::grpc::internal::RpcMethod::NORMAL_RPC,
      new ::grpc::internal::RpcMethodHandler< KVStoreService::Service, ::kvstore::RemoveRequest, ::kvstore::RemoveResponse, ::grpc::protobuf::MessageLite, ::grpc::protobuf::MessageLite>(
          [](KVStoreService::Service* service,
             ::grpc::ServerContext* ctx,
